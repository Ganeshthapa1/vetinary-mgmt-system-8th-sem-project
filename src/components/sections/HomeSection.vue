      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class="animate-fade-in-left">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <button @click="$emit('set-active-section', 'appointment')" 
            ...
            <button @click="$emit('set-active-section', 'services')"
        ...
        <div class="animate-fade-in-right">
          <div class="relative">
            <img src="{{ }}" alt="Veterinarian with pet" class="rounded-lg shadow-2xl">
    ...
    <div class="bg-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div v-for="stat in stats" :key="stat.label" class="text-center animate-fade-in-up">
