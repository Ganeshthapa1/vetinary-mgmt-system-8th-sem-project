...
<script>
import { CheckCircle, Heart, Activity, Shield } from 'lucide-vue-next'
import { petCareTips } from '../../data/petCareTips.js'

export default {
  name: 'PetCareTipsSection',
  components: { CheckCircle, Heart, Activity, Shield },
  data() {
    return {
      petCareTips
    }
